...
public class Alerts {
    ...
    public static String Elige_Modo() {
        ...
        alert.setHeaderText("PersVSPers: Partida persona contra persona." +
                "\nPersVSOrden: Partida persona contra el ordenador." +
                "\nOrdenVSOrden: Partida ordenador contra ordenador");

        ButtonType btHumanoVsHumano = new ButtonType("PersVSPers");
        ButtonType btHumanoVsCom = new ButtonType("PersVSOrden");
        ButtonType btComVsCom = new ButtonType("OrdenVSOrden");
